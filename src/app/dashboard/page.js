    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#0a0f1c', color: '#f8fafc', fontFamily: '"Inter", sans-serif' }}>
      ...
      <div style={{ width: '260px', backgroundColor: '#0b101e', borderRight: '1px solid rgba(255,255,255,0.05)', display: 'flex', flexDirection: 'column', padding: '24px 0' }}>
        ...
        <div style={{ padding: '0 24px', marginBottom: '40px', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <img src="/icon.png" alt="Trading Brain AI" style={{ width: '32px', height: '32px', filter: 'drop-shadow(0 0 8px rgba(34, 211, 238, 0.5))' }} />
          <span style={{ fontSize: '1.25rem', fontWeight: '800', letterSpacing: '-0.5px' }}>Trading Brain</span>
        </div>

        {/* Navigation Links */}
        <nav style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '4px' }}>
          <div style={{ padding: '12px 24px', backgroundColor: 'rgba(34, 211, 238, 0.1)', borderLeft: '3px solid #22d3ee', color: '#22d3ee', display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer', fontWeight: '600' }}>
            <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
            Dashboard
          </div>
          {['Trading Terminal', 'Analytics', 'TradingView', 'Leaderboard', 'Affiliates'].map(item => (
            <div key={item} style={{ padding: '12px 24px', color: '#64748b', display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer', borderLeft: '3px solid transparent', transition: 'all 0.2s' }}>
              <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
              {item}
            </div>
          ))}
        </nav>
        ...
        <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <button style={{ width: '100%', background: 'rgba(30, 41, 59, 0.5)', color: '#94a3b8', border: '1px solid rgba(255,255,255,0.05)', padding: '10px', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', justifyContent: 'center', gap: '8px' }}>
          ...
          <button style={{ width: '100%', background: 'linear-gradient(90deg, #facc15, #eab308)', color: '#451a03', border: 'none', padding: '10px', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', boxShadow: '0 0 15px rgba(234, 179, 8, 0.3)' }}>
            Start Challenge
          </button>
        </div>
      </div>
      ...
      <div style={{ flex: 1, padding: '32px 40px', overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <h1 style={{ fontSize: '1.5rem', fontWeight: '800', margin: 0 }}>Analytics</h1>
            ...
            <span style={{ background: 'rgba(34, 211, 238, 0.1)', color: '#22d3ee', padding: '4px 8px', borderRadius: '4px', fontSize: '0.75rem', fontWeight: 'bold', border: '1px solid rgba(34,211,238,0.2)' }}>Evaluation</span>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '24px' }}>
          ...
          <div style={{ background: '#101726', padding: '24px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.03)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: loading ? '#facc15' : '#22d3ee', boxShadow: loading ? '0 0 8px #facc15' : '0 0 8px #22d3ee' }}></div>
                <h2 style={{ fontSize: '1rem', margin: 0, color: '#94a3b8' }}>API Connection</h2>
              </div>
            </div>
            {apiKey ? (
              <div style={{ display: 'flex', gap: '12px' }}>
                ...
                <button onClick={() => navigator.clipboard.writeText(apiKey)} style={{ background: 'rgba(255,255,255,0.1)', color: 'white', border: 'none', padding: '0 20px', borderRadius: '6px', fontWeight: '600', cursor: 'pointer', fontSize: '0.875rem', transition: 'background 0.2s' }}>Copy</button>
              </div>
            ) : (
              <button onClick={generateApiKey} disabled={loadingKey} style={{ background: 'rgba(34, 211, 238, 0.1)', color: '#22d3ee', border: '1px solid rgba(34, 211, 238, 0.3)', padding: '10px 24px', borderRadius: '6px', fontWeight: '600', cursor: 'pointer', width: '100%' }}>
          ...
          <div style={{ background: '#101726', padding: '24px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.03)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <h2 style={{ fontSize: '1.1rem', margin: '0 0 4px 0', fontWeight: '700' }}>Local Superpowers Engine</h2>
                <p style={{ color: '#64748b', margin: 0, fontSize: '0.875rem' }}>Download NT8 AddOn (Copier + Sync)</p>
              </div>
              <button onClick={() => window.open('https://github.com/rommelyalejandro', '_blank')} style={{ background: '#22c55e', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '6px', fontWeight: '600', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', boxShadow: '0 0 15px rgba(34, 197, 94, 0.2)' }}>
        ...
        <div style={{ display: 'flex', gap: '24px', marginBottom: '24px' }}>
          ...
          <div style={{ flex: 1, background: '#101726', padding: '24px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.03)', position: 'relative', overflow: 'hidden' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '40px' }}>
              ...
              <h2 style={{ fontSize: '1rem', margin: 0, fontWeight: '600' }}>Trading Growth Curve</h2>
            ...
            <div style={{ position: 'relative', height: '200px', width: '100%', borderBottom: '1px solid #ef4444', borderTop: '1px dashed #22c55e', display: 'flex', alignItems: 'center' }}>
              <svg width="100%" height="100%" viewBox="0 0 800 200" preserveAspectRatio="none">
                ...
                <path d="M0,100 Q100,80 200,100 T400,120 T600,140 T700,180 L750,150 L800,150" fill="none" stroke="#facc15" strokeWidth="2" />
              </svg>
            </div>
          ...
          <div style={{ width: '280px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ background: '#101726', padding: '16px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.03)', display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div><p style={{ margin: 0, fontSize: '0.65rem', color: '#94a3b8', letterSpacing: '1px', textTransform: 'uppercase' }}>Net Profit Loss</p><h3 style={{ margin: 0, fontSize: '1.25rem', color: '#f8fafc' }}>${(totalLots * 12.5).toFixed(2)}</h3></div>
            </div>
            <div style={{ background: '#101726', padding: '16px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.03)', display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div><p style={{ margin: 0, fontSize: '0.65rem', color: '#94a3b8', letterSpacing: '1px', textTransform: 'uppercase' }}>Total Trades</p><h3 style={{ margin: 0, fontSize: '1.25rem', color: '#f8fafc' }}>{totalTrades}</h3></div>
            </div>
            <div style={{ background: '#101726', padding: '16px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.03)', display: 'flex', alignItems: 'center', gap: '16px' }}>
              <div style={{ background: 'rgba(59, 130, 246, 0.1)', padding: '10px', borderRadius: '8px', color: '#3b82f6' }}><svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg></div>
